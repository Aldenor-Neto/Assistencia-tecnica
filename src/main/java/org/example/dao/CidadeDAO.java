...
public class CidadeDAO extends ConexaoDB {
    ...
    public void insertCidade(Cidade entidade) {
        try (PreparedStatement preparedStatement = prepareSQL(INSERT_CIDADE_SQL)) {
    ...
    public Cidade selectCidade(int id) {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_CIDADE_BY_ID)) {
    ...
    public List<Cidade> selectAllCidade() {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_ALL_CIDADE)) {
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteCidade(int id) throws SQLException {
        try (PreparedStatement statement = prepareSQL(DELETE_CIDADE_SQL)) {
    ...
    public boolean updateCidade(Cidade entidade) throws SQLException {
        try (PreparedStatement statement = prepareSQL(UPDATE_CIDADE_SQL)) {
