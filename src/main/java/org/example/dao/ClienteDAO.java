...
public class ClienteDAO extends ConexaoDB {
    ...
    public void insertCliente(Cliente entidade) {
        try (PreparedStatement preparedStatement = prepareSQL(INSERT_CLIENTE_SQL)) {
    ...
    public Cliente selectCliente(int id) {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_CLIENTE_BY_ID)) {
    ...
    public List<Cliente> selectAllCliente() {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_ALL_CLIENTE)) {
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteCliente(int id) throws SQLException {
        try (PreparedStatement statement = prepareSQL(DELETE_CLIENTE_SQL)) {
    ...
    public boolean updateCliente(Cliente entidade) throws SQLException {
        try (PreparedStatement statement = prepareSQL(UPDATE_CLIENTE_SQL)) {
