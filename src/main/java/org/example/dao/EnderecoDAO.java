...
public class EnderecoDAO extends ConexaoDB {
    ...
    private static final String DELETE_ENDERECO = "DELETE FROM endereco WHERE id = ?;";
    ...
    public void insertEndereco(Endereco entidade) {
        try (PreparedStatement preparedStatement = prepareSQL(INSERT_ENDERECO_SQL)) {
    ...
    public Endereco selectEndereco(int id) {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_ENDERECO_BY_ID)) {
    ...
    public List<Endereco> selectAllEndereco() {
        ...
        try (PreparedStatement preparedStatement = prepareSQL(SELECT_ALL_ENDERECO)) {
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteEndereco(int id) throws SQLException {
        try (PreparedStatement statement = prepareSQL(DELETE_ENDERECO)) {
    ...
    public boolean updateEndereco(Endereco entidade) throws SQLException {
        try (PreparedStatement statement = prepareSQL(UPDATE_ENDERECO_SQL)) {
